...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::channel_get_videos,
            commands::channel_sync_start,
            commands::channel_sync_cancel,
            commands::channel_sync_active,
            commands::channel_enrich_active,
            commands::channel_enrich_start,
            commands::channel_enrich_cancel,
            commands::test_proxy,
            db::db_health_check,
